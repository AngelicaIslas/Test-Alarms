...
let participantSelection = {
    alarm1: { category: 'Not selected', priority: 'Not selected' },
    alarm2: { category: 'Not selected', priority: 'Not selected' }
};
...
function playTestPair() {
    ...
    if (stepDesign === "combined") {
        alarm1 = getRandomAlarm("icons"); // Get an icon alarm
        alarm2 = getRandomAlarm("melodics"); // Get a melodic alarm
        // Set the design in participantSelection
        participantSelection.alarm1.design = "Icons";
        participantSelection.alarm2.design = "Melodic";
    } else {
...
function getRandomAlarm(design) {
    const categories = ["Cardiovascular", "Ventilation", "DrugAdministration"];
    const priorities = ["High", "Medium"];
